...
public class PageTurner extends Application {
    ...
    public static final String MIXPANEL_TOKEN = "e956af065270fff6d9e1985902087498";
	...
	public void onCreate() {
        ...
        try{
            mixpanel =
                    MixpanelAPI.getInstance(this.getBaseContext(), MIXPANEL_TOKEN);
            JSONObject props = new JSONObject();
            props.put("accessed", "true");
            mixpanel.track("acruti_reader", props);
            mixpanel.flush();
